...
export const step1Template = () => `
  ${stepTemplate(1)}
  <section id="step1-container" class="w-full flex justify-center items-center">
    <div class="w-full">
      <div class="mb-6">
        <label for="video-url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">비디오 URL</label>
        <input id="url-input" value="./video/abc.mp4" type="text" id="video-url" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      </div>
...
${stepTemplate(2)}
  <section class="step2-container w-full flex justify-center items-center">
    <div class="w-full">
      <div class="my-4">
      <h2 class="text-2xl font-bold dark:text-white mb-2">자르기</h2>
      <div>
        <img id="img" src=${imageSrc} alt="이미지" />
      </div>
    </div>
    <div class="my-4">
...
${stepTemplate(3)}
  <section class="flex flex-col gap-4">
    ...
    <div class="mt-4">
      <a href=${url} id="download" download="download" class="flex justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">다운로드</a>
    </div>
  </section>
`
