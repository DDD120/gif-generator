  ...
  template() {
    ...
    return `
      ...
      <main class="flex flex-col gap-4 w-full">
        ...
        <div class="mt-4">
          <a href=${gifSrc} id="download" download=${download} class="flex justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">다운로드</a>
        </div>
      </main>
    `
  }
